...
- Si el usuario pide un horario no estandar entre 08:00 y 00:00, usalo tal cual en la accion sin aproximarlo a uno estandar
...
4. Nombre completo
5. Telefono (pedilo siempre explicitamente si no lo tenes confirmado con este mensaje exacto: "¿Cuál es tu número de celular? Escribilo sin el 0 y sin el 15, solo los 10 dígitos. Ejemplo: 2983448712"; NUNCA inventes ni asumas un numero)
...
def ejecutar_accion(accion: dict, telefono_confirmado: str = None) -> str:
    ...
    if tipo == "preparar_multiples_reservas":
        ...
        if not accion.get("hora"):
            return "FALTA_HORA: Para consultar disponibilidad necesito que le preguntes al usuario a qué hora quiere jugar."
