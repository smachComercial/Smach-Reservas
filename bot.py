...
def llamar_mistral(
    ...
    # Si el texto quedó vacío (Mistral respondió solo con <ACCION>), dejarlo vacío.
    # El "." se eliminó: NUNCA debe enviarse al usuario ni guardarse en el historial.
    # texto puede quedar "" y el flujo en manejar_mensaje_wa lo maneja correctamente.
    ...
    try:
        ...
        if accion:
            ...
            if resultado == "RESERVA_LISTA":
                ...
                if texto_respuesta:  # no guardar strings vacíos en historial
                    historial.append({"role": "assistant", "content": texto_respuesta})
                ...
                if accion_final:
                    ...
                    if texto_final:  # no enviar ni guardar strings vacíos
                        historial.append({"role": "assistant", "content": texto_final})
                    sesion["historial"] = historial[-20:]
                    sesion_set(wa_id, sesion)
                    if texto_final:
