...
def ejecutar_accion(accion: dict, telefono_confirmado: str = None) -> str:
    ...
    if tipo == "preparar_multiples_reservas":
        ...
        if reserva.get("telefono_cliente") != telefono_confirmado:
        ...
        for rid in ids:
            ...
            elif reserva.get("telefono_cliente") != telefono_confirmado:
...
def manejar_mensaje_wa(wa_id: str, texto_usuario: str):
    ...
    try:
        ...
        if accion:
            ...
            PALABRAS_CONSULTA = [
                "disponib", "turno", "cancha", "horario", "grilla",
                "reserva", "mis reservas", "tengo reserva", "mis turnos",
            ]
