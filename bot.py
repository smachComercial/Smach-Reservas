    ...
    try:
        ...
        if accion:
            ...
            if resultado == "RESERVA_LISTA":
                ...
                # Para consultar_disponibilidad en medio de una reserva, usar historial completo
                # para que Mistral recuerde el contexto (fecha, hora, cancha ya elegidas).
                # Para el resto, recortar a [-12:] para evitar que reutilice datos viejos.
                if accion.get("tipo") == "consultar_disponibilidad":
                    historial_limpio = historial
                else:
